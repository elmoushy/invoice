...
//   actions: {
//     /**
//      * Load an existing invoice from the server,
//      * converting "lines" => "invoice_lines" and "payments" => "payment_details".
//      * This action will only run if the invoice is not already loaded.
//      */
...
//         // Transform lines → invoice_lines
//         const invoiceLines = serverData.lines || []

//         // Transform payments → payment_details
//         const paymentDetails = serverData.payments || []

//         // Build the transformed data object and ensure new fields exist
...
//         // If there is at least one payment, map top-level fields accordingly
//         if (paymentDetails.length > 0) {
//           const firstPayment = paymentDetails[0]
//           let typeCode = firstPayment.payment_means_type_code
//           if (typeCode === 'cash') {
//             typeCode = '97' // Front-end uses "97" for Cash
//           }
...
//           transformedData.cvv = '' // typically blank for security
//         }
...
//     // Simple setter to update a field in invoiceData
//     updateField(field, value) {
//       this.invoiceData[field] = value
//     },

//     // Reset all invoice data and the loaded flag
//     resetInvoiceData() {
//       this.invoiceData = {
//         invoice_issue_date: '',
//         invoice_type_code: '',
